        ...
        <div ref={contentRef} className="flex flex-col items-center gap-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-2 w-full">
            <Link
              ...
              className="group inline-flex items-center justify-center gap-3 h-14 px-10 w-full sm:w-auto bg-gold/10 border border-gold/60 rounded-[3px] font-inter text-[11px] tracking-[0.18em] text-gold uppercase hover:bg-gold hover:text-navy-900 hover:border-gold transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)]"
            >
              Start a project
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 h-14 px-7 w-full sm:w-auto rounded-[3px] font-inter text-[11px] tracking-[0.18em] text-cream/40 uppercase hover:text-cream/75 border border-white/10 hover:border-white/25 transition-all duration-300"
            >
              hello@ostoia.co
            </a>
          </div>
